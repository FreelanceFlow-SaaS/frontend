...
const steps = [
  {
    ...
    desc: "Créez votre compte en 30 secondes. Aucune carte requise.",
  },
    ...
    <div className={`${dmSans.className} landing-root`}>
      ...
      <section className="landing-hero">
        ...
        <div className="landing-hero-content">
          ...
          <h1
            className={`${instrumentSerif.className} landing-hero-h1 lp-reveal`}
          ...
          <p className="landing-hero-sub lp-reveal" style={{ animationDelay: "0.4s" }}>
            Gérez vos clients, prestations et factures depuis une interface moderne. Calcul
            automatique HT/TVA/TTC, export PDF et suivi des statuts — tout ce qu&apos;il faut, rien
            de superflu.
          </p>
        ...
        <div className="landing-section-inner">
          ...
          <div className="landing-features-grid">
            {features.map((f, i) => (
              <div
                key={f.label}
                className="landing-feature-card lp-reveal-scroll"
        ...
        <div className="landing-section-inner">
          ...
          <div className="landing-steps-row">
            {steps.map((s, i) => (
              <div
                key={s.num}
                className="landing-step lp-reveal-scroll"
        ...
        <div className="landing-section-inner">
          <div className="landing-stats-grid">
            {[
              ...
              <div
                key={s.label}
                className="landing-stat lp-reveal-scroll"
                style={{ animationDelay: `${0.1 * i}s` }}
              >
      ...
      <section className="landing-final-cta">
        ...
        <div className="landing-section-inner landing-final-cta-inner">
          <h2 className={`${instrumentSerif.className} landing-final-h2 lp-reveal-scroll`}>
            ...
            <span className="landing-accent">dès aujourd&apos;hui.</span>
          </h2>
          <p className="landing-final-sub lp-reveal-scroll" style={{ animationDelay: "0.1s" }}>
            Inscription gratuite, sans carte bancaire. Commencez à facturer en moins d&apos;une
            minute.
          </p>
          <Link
            href="/register"
            className="landing-btn-primary lp-reveal-scroll"
      ...
      <footer className="landing-footer">
        <div className="landing-footer-inner">
          ...
          <span className="landing-footer-copy">
            &copy; {new Date().getFullYear()} &mdash; Projet open source sous licence MIT
          </span>
        </div>
      </footer>
      ...
      <style jsx global>{`
        ...
        .landing-hero-glow {
          ...
          background: radial-gradient(
            circle,
            color-mix(in oklch, var(--lp-accent) 12%, transparent) 0%,
            transparent 70%
          );
          pointer-events: none;
        }
        ...
        .landing-hero-badge {
          ...
          border: 1px solid color-mix(in oklch, var(--lp-accent) 24%, transparent);
          border-radius: 999px;
          padding: 0.4rem 1rem;
          margin-bottom: 2rem;
        }
        ...
        .landing-feature-card:hover {
          border-color: color-mix(in oklch, var(--lp-accent) 40%, transparent);
        ...
        .landing-feature-icon {
          ...
          border-radius: 12px;
          background: var(--lp-accent-glow);
          border: 1px solid color-mix(in oklch, var(--lp-accent) 18%, transparent);
          color: var(--lp-accent);
        ...
        .landing-step-num {
          font-size: 3.5rem;
          line-height: 1;
          color: color-mix(in oklch, var(--lp-accent) 18%, transparent);
          display: block;
          margin-bottom: 1rem;
        }
        .landing-step-title {
        ...
        .landing-final-cta-glow {
          ...
          background: radial-gradient(
            circle,
            color-mix(in oklch, var(--lp-accent) 10%, transparent) 0%,
            transparent 70%
          );
          pointer-events: none;
        }
